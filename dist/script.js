...
var animateCSS = function animateCSS(element, animation) {
  return (// We create a Promise and return it
    new Promise(function (resolve, reject) {
      element.classList.add('animated', animation); // When the animation ends, we clean the classes and resolve the Promise
...
/* harmony import */ var _modules_showUp__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/showUp */ "./src/js/modules/showUp.js");
...
/* harmony import */ var _modules_playVideo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/playVideo */ "./src/js/modules/playVideo.js");
...
window.addEventListener('DOMContentLoaded', function () {
  //Big sliders
  var pageIndexSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.page',
    btns: '.next'
  });
  pageIndexSlider.render();
  var pageModulesSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.moduleapp',
    btns: '.next',
  ...
  new _modules_accordion__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold').init();
  new _modules_accordion__WEBPACK_IMPORTED_MODULE_3__["default"]('.officernew').init();
  new _modules_showUp__WEBPACK_IMPORTED_MODULE_2__["default"]('.module__info-show').init(); /////////////////////////////////////

  new _modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"]('.form').init();
  new _modules_download__WEBPACK_IMPORTED_MODULE_5__["default"]('.download').downloadFile(); //Video players

  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_6__["default"]('.showup .play', '.overlay').init();
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_6__["default"]('.module__video-item .play', '.overlay').init(); /////////////////////////////////////
});
...
/* harmony import */ var _helpers_slide__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helpers/slide */ "./src/js/helpers/slide.js");
...
function () {
  function Accordion(accordionBlock) {
    ...
    try {
      this.accordionItems = this.block.children;
    } catch (err) {}
    ...
    try {
      this.module = this.block.parentNode.querySelector(module);
    } catch (err) {}
  ...
  _createClass(Accordion, [{
    key: "openItems",
    value: function openItems(items, counter) {
      ...
      var lastItem = items[itemLength - 1];
      lastItem.querySelector('.plus').addEventListener('click', function () {
        if (counter === itemLength - 2) lastItem.remove();
        if (counter !== itemLength - 1) Object(_helpers_slide__WEBPACK_IMPORTED_MODULE_1__["default"])(lastItem, 'fadeInUp');
        Object(_helpers_slide__WEBPACK_IMPORTED_MODULE_1__["default"])(items[counter], 'fadeInDown');
  ...
  _createClass(Download, [{
    ...
    value: function watchId(elem) {
      switch (elem.closest('.module').getAttribute('id')) {
        ...
        case '2':
          this.path = 'assets/img/download/2.png';
          this.name = 'picture 2';
          break;

        case '3':
          this.path = 'assets/img/download/3.png';
          this.name = 'picture 3';
          break;

        case '4':
          this.path = 'assets/img/download/4.png';
          this.name = 'picture 4';
          break;

        case '5':
          this.path = 'assets/img/download/5.png';
          this.name = 'picture 5';
          break;

        case '6':
          this.path = 'assets/img/download/6.png';
          this.name = 'picture 6';
          break;

        case '7':
          this.path = 'assets/img/download/7.png';
          this.name = 'picture 7';
          break;

        case '8':
          this.path = 'assets/img/download/8.png';
          this.name = 'picture 8';
          break;
      }
    ...
    value: function downloadFile() {
      ...
      this.download.forEach(function (load) {
        load.addEventListener('click', function () {
          _this.watchId(load);

          var link = document.createElement('A');
          link.setAttribute('href', _this.path);
          link.setAttribute('download', _this.name);
  ...
  _createClass(Forms, [{
    ...
    value: function phoneMask() {
      ...
      function createMask(event) {
        var matrix = '+1 (___)___-____'; //Here is our mask
    ...
    value: function checkMailInputs() {
      ...
      mailInputs.forEach(function (mail) {
    ...
    value: function init() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          e.preventDefault(); //append status message for user

          var statusMessage = document.createElement('img');
          form.parentNode.appendChild(statusMessage);
          statusMessage.style.cssText = "\n          width: 50px;\n          heigh: 50px;\n          margin-left: 72px;\n          margin-top: 10px;\n        "; /////////////////////////////////////

          statusMessage.setAttribute('src', _this.message.loadingPath);
          statusMessage.setAttribute('alt', 'loading');
          var formData = new FormData(form);

          _this.fetchData(_this.postPath, formData) //change notifications depending on the result
          .then(function (res) {
            statusMessage.setAttribute('src', _this.message.successPath);
            statusMessage.setAttribute('alt', 'success');
            console.log(res);
          }).catch(function (err) {
            statusMessage.setAttribute('src', _this.message.errorPath);
...
function () {
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn, i) {
        ...
        btn.addEventListener('click', function () {
          _this.clickedBtn = btn; //current(clicked) videoplayer for onPlayerStateChange

          if (btn.getAttribute('data-locked') === 'false') {
            //create new player only if it hasn't been opened
            if (document.querySelector('iframe#frame')) {
              _this.overlay.style.display = 'flex'; //open other video by click on other btn
    ...
    value: function onPlayerStateChange(state) {
      try {
        var blockedElem = this.clickedBtn.closest('.module__video-item').nextElementSibling;
        var playCircle = blockedElem.querySelector('.play__circle');
        var playSVG = this.clickedBtn.querySelector('SVG').cloneNode(true); //clones play svg

        if (state.data === 0) {
          //state.data = 0 => video has been watched
...
/*#__PURE__*/
function () {
  function ShowUp(blocks) {
    _classCallCheck(this, ShowUp);
  ...
  _createClass(ShowUp, [{
    ...
    value: function init() {
      this.blocks.forEach(function (block) {
        ...
        var msg = block.nextElementSibling;
        var nextOne = msg.nextElementSibling;
        var nextTwo = nextOne.nextElementSibling;
        plus.setAttribute('data-opened', 'false');
        plus.addEventListener('click', function () {
          if (plus.getAttribute('data-opened') === 'false') {
            plus.setAttribute('data-opened', 'true');
            msg.style.display = 'block';
            Object(_helpers_slide__WEBPACK_IMPORTED_MODULE_1__["default"])(msg, 'fadeInDown');
            Object(_helpers_slide__WEBPACK_IMPORTED_MODULE_1__["default"])(nextOne, 'slideInDown');
            Object(_helpers_slide__WEBPACK_IMPORTED_MODULE_1__["default"])(nextTwo, 'slideInDown');
          } else {
            plus.setAttribute('data-opened', 'false');
            Object(_helpers_slide__WEBPACK_IMPORTED_MODULE_1__["default"])(nextTwo, 'slideOutUp');
            Object(_helpers_slide__WEBPACK_IMPORTED_MODULE_1__["default"])(nextOne, 'slideOutUp');
            Object(_helpers_slide__WEBPACK_IMPORTED_MODULE_1__["default"])(msg, 'fadeOutUp').then(function () {
...
/* harmony import */ var _helpers_slide__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../helpers/slide */ "./src/js/helpers/slide.js");
...
function (_Slider) {
  ...
  function MainSlider(btns) {
    ...
    _this.logoClicked = false; //variable for watch the click on logo
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      if (n < 1) this.slideIndex = this.slides.length; //hides every slide
      ...
      try {
        ...
        if (n === 3) {
          setTimeout(function () {
            ...
            Object(_helpers_slide__WEBPACK_IMPORTED_MODULE_10__["default"])(_this2.hanson, 'fadeInUpBig');
          }, 3000);
        } /////////////////////////////////////
    ...
    key: "switchSlides",
    value: function switchSlides(n, logoClicked) {
      var prevOrNext = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      this.showSlides(this.slideIndex += n); //change slide

      var currentSlide = this.slides[this.slideIndex - 1];
      logoClicked ? Object(_helpers_slide__WEBPACK_IMPORTED_MODULE_10__["default"])(currentSlide, 'fadeIn') : //fadeIn animation only for logo
      !prevOrNext ? Object(_helpers_slide__WEBPACK_IMPORTED_MODULE_10__["default"])(currentSlide, 'slideInUp') : //for prev animation up
      Object(_helpers_slide__WEBPACK_IMPORTED_MODULE_10__["default"])(currentSlide, 'slideInDown'); //for next animation down
    } //left/right(.prevmodule/.nextmodule) arrows

  }, {
    key: "bindControlsArrows",
    value: function bindControlsArrows(module) {
      var _this3 = this;

      module.forEach(function (btn) {
        btn.addEventListener('click', function (e) {
          e.stopPropagation();
          e.preventDefault();
          module === _this3.modulePrev ? _this3.switchSlides(-1, false, 'prev') : _this3.switchSlides(1, false);
        });
      });
    ...
    value: function bindArrows() {
      ...
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          ...
          btn.tagName === 'A' ? _this4.switchSlides(1) : _this4.slides[_this4.slideIndex - 1].style.display = 'block';
        }); //show the first slide on logo click

        btn.parentNode.previousElementSibling.addEventListener('click', function (e) {
          if (btn.tagName === 'A') {
            e.preventDefault();
            _this4.logoClicked = true;
            _this4.slideIndex = 1;

            _this4.switchSlides(0, _this4.logoClicked, null);
          }
    ...
    value: function render() {
      if (this.container) {
        //different containers for different pages
        try {
...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, activeClass, style, autoplay) {
    var _this;

    _classCallCheck(this, MiniSlider);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, activeClass, style, autoplay));
    _this.slideInterval;
    return _this;
  }
  ...
  _createClass(MiniSlider, [{
    key: "styleFirstSlide",
    value: function styleFirstSlide() {
      var _this2 = this;
    ...
    value: function switchSlide() {
      ...
      var button = this.container.querySelectorAll('BUTTON'); //find all buttons(.feed__slider)
      //next arrow

      this.next.addEventListener('click', function () {
        //skip buttons
        if (_this3.slides[1] === button[0]) {
          _this3.container.appendChild(button[0]);

          _this3.container.appendChild(button[1]);
        ...
        _this3.styleFirstSlide();
      }); //
      //previous arrow

      this.prev.addEventListener('click', function () {
        //conditional operator for skip buttons
        _this3.slides[_this3.slides.length - 1] === button[1] ? _this3.container.insertBefore(_this3.slides[_this3.slides.length - 3], _this3.slides[0]) : _this3.container.insertBefore(_this3.slides[_this3.slides.length - 1], _this3.slides[0]); //
    ...
    value: function autoSwitch() {
      ...
      if (this.autoplay) {
        this.slideInterval = setInterval(function () {
          _this4.container.appendChild(_this4.slides[0]);

          _this4.styleFirstSlide();
        }, 5000);
      }
    ...
    value: function init() {
      ...
      try {
        ...
        this.autoSwitch();
        [this.container, this.prev, this.next].forEach(function (elem) {
          elem.addEventListener('mouseover', function () {
            return clearInterval(_this5.slideInterval);
          });
          elem.addEventListener('mouseleave', function () {
            return _this5.autoSwitch();
          });
        });
      } catch (err) {}
    }
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$moduleNext = _ref.moduleNext,
      moduleNext = _ref$moduleNext === void 0 ? null : _ref$moduleNext,
      _ref$prev = _ref.prev,
      prev = _ref$prev === void 0 ? null : _ref$prev,
      _ref$modulePrev = _ref.modulePrev,
      modulePrev = _ref$modulePrev === void 0 ? null : _ref$modulePrev,
